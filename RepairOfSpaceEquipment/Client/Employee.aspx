<%@ Page Title="Employees" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Employee.aspx.cs" Inherits="Client.Employee" %>
        ...
        <form runat="server">
            ...
            <asp:GridView ID="gvResult" runat="server" CellPadding="4" CssClass="table" ForeColor="#333333"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="role.description" HeaderText="Role" />
                    <asp:TemplateField HeaderText="Actions">
                        <ItemTemplate>
                            <asp:LinkButton runat="server" ID="btnAlterarMidia" CommandName="UPDATE"
                                CommandArgument='<%# Eval("id") %>' CssClass="btn btn btn-warning" Text="Update" />
                            <asp:LinkButton runat="server" ID="btnExcluirMidia" CommandName="DELETE"
