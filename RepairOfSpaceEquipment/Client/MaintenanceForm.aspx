<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="MaintenanceForm.aspx.cs" Inherits="Client.MaintenanceForm" %>
                ...
                <div class="col-5">
                   <div class="form-group">
                       <asp:Label ID="Label1" runat="server" Text="Employee"></asp:Label>
                        <asp:DropDownList CssClass="form-control" ID="ddlEmployee" runat="server"></asp:DropDownList>
                   </div>
                </div>
                <div class="col-5">
                   <div class="form-group">
                       <asp:Label ID="Label2" runat="server" Text="Equipment"></asp:Label>
                        <asp:DropDownList CssClass="form-control" ID="ddlEquipment" runat="server"></asp:DropDownList>
                   </div>
                </div>
                <div class="col-5">
                    <div class="form-group">
