<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Maintenance.aspx.cs" Inherits="Client.Maintenance" %>
        ...
        <form runat="server">
            ...
            <asp:GridView ID="gvResult" runat="server" CellPadding="4" CssClass="table" ForeColor="#333333"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="employee.role.description" HeaderText="Role" />
                    <asp:BoundField DataField="equipment.descricao" HeaderText="Equipment" />
