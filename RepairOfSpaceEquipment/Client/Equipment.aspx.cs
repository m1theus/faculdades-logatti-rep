...
namespace Client
{
    public partial class Equipment : System.Web.UI.Page
    {
        ...
        protected void GVResult_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("EquipmentForm.aspx?id=" + idItem);
            }
        ...
        protected void btnConfirm_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var equipment = context.equipment.First(x => x.id == id);

                if (equipment.maintenance.ToList().Count() > 0)
                {
                    SendMessage("Não é possível excluir este 'Equipment', pois há vinculo com um 'Maintenance'.", Color.Red);
                    return;
                }

                context.equipment.Remove(context.equipment.First(x => x.id == id));
                context.SaveChanges();
        ...
        {
            gvResult.DataSource = context.equipment.ToList();
            gvResult.DataBind();
        }
        ...
        protected void btnRegister_Click(object sender, EventArgs e) => Response.Redirect("EquipmentForm.aspx");
    }
}